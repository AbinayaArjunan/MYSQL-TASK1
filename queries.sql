...
-- (2,'kabali','Rajinikanth'),(3,'Beast','Vijay'),(4,'LoveToday','Pradeep');
...
-- INSERT INTO genre(genre_id,movie_id,movie_genre) values(1,1,"Action"),(2,4,"Romance"),(3,4,"comedy");
-- select * from genre;
-- +----------+----------+-------------+
...
-- | Field          | Type         | Null | Key | Default | Extra |
-- +----------------+--------------+------+-----+---------+-------+
-- | artistskill_id | int          | NO   | PRI | NULL    |       |
-- | movie_id       | int          | NO   | MUL | NULL    |       |
-- | skills         | varchar(255) | YES  |     | NULL    |       |
-- +----------------+--------------+------+-----+---------+-------+

-- insert into artist_skill(artistskill_id,movie_id,skills) values(1,1,"dancer"),(2,2,"kingofStyle"),(3,1,"dancer");

-- select * from artist_skill
-- +----------------+----------+-------------+
-- | artistskill_id | movie_id | skills      |
-- +----------------+----------+-------------+
-- |              1 |        1 | dancer      |
-- |              2 |        2 | kingofStyle |
-- |              3 |        3 | dancer      |
